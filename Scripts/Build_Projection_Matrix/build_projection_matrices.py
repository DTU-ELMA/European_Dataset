...
windmask = np.load('../../Data/Metadata/entsoe_windmask.npy').astype(bool)
solarmask = np.load('../../Data/Metadata/entsoe_solarmask.npy').astype(bool)
lats = np.load('../../Data/Metadata/lats.npy')
lons = np.load('../../Data/Metadata/lons.npy')
...
np.savez('../../Data/Metadata/loadtransfercsr.npz', data=loadtransferout.data, indices=loadtransferout.indices, indptr=loadtransferout.indptr, shape=loadtransferout.shape)
...
np.savez('../../Data/Metadata/wndtransfercsr.npz', data=wndtransferout.data, indices=wndtransferout.indices, indptr=wndtransferout.indptr, shape=wndtransferout.shape)
...
np.savez('../../Data/Metadata/solartransfercsr.npz', data=solartransferout.data, indices=solartransferout.indices, indptr=solartransferout.indptr, shape=solartransferout.shape)
