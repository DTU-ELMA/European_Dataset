...
wndtransfer = np.load('../../Data/Metadata/wndtransfercsr_COSMO.npz')
...
solartransfer = np.load('../../Data/Metadata/solartransfercsr_COSMO.npz')
...
onshore = np.load('../../Data/Metadata/onshore_COSMO.npy')
...
np.save('../../Data/Metadata/Node_area_wind_onshore_COSMO.npy', wndareaon)
np.save('../../Data/Metadata/Node_area_wind_offshore_COSMO.npy', wndareaoff)
np.save('../../Data/Metadata/Node_area_PV_COSMO.npy', solarareaon)
